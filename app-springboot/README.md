...
This is a modified sample of keycloak spring-boot application example project to implement cookie based authentication
The following are the changes made
1)  The components to implement cookie-based authentication are placed under components package
2)  Security Config is modified to use it for stateless authentication.
